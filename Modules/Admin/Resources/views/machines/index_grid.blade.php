        ...
        <div class="col-md-4">
          <div class="right">
            <div class="table-search d-flex" style="margin-top: -35px;float: right;">
              <form action="/admin/machines/search_gridview" method="POST">
                @csrf
                ...
                <ul class="legend3 d-flex align-items-center mb-30">
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="text">
                        <form action="/admin/machines/filter_gridview" method="POST">
                          @csrf
          ...
          @foreach($customers as $customer)
              <div class="card-style-3 mb-30">
                  <div class="card-content">
                      <h4><a href="/admin/customers/edit/{{ $customer->id }}">Cliente: {{ $customer->name }}</a></h4>
                      <div id="grid">
