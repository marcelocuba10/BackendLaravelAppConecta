    ...
    <div class="form-layout-wrapper">
      <div class="card-style activity-card mb-30">
        <div class="row">
                ...
                <ul class="legend3 d-flex align-items-center mb-30">
                  <li>
                    <div class="d-flex">
                      ...
                      <div class="text">
                        {{-- <form action="/admin/machines/filter_gridview_api" method="POST"> --}}
                          @csrf
            ...
            <div class="right">
              ...
              <ul class="legend3 d-flex align-items-center mb-30">
                <li>
                  <div class="d-flex">
                    <div class="text">
                      <form action="/admin/machines/search_gridview_api" method="POST">
                        @csrf
          ...
          <div id="post-data">
            {{-- @include('admin::machines._partials.data') --}}
          </div>
