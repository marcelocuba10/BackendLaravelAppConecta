        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              ...
              @can('machine-sa-create')
                <a href="/admin/machines/create" class="main-btn info-btn btn-hover btn-sm"><i class="lni lni-plus mr-5"></i> Nuevo</a>
              @endcan 
              <a style="margin-left: 17px;" href="/admin/machines/grid_view"><i class="hthtg lni lni-grid-alt"></i></a>
              <a style="margin-left: 17px;" href="/admin/machines/list"><i class="hthtg lni lni-list"></i></a>
              {{-- <a style="margin-left: 17px;" href="{{route('machines.admin.createPDF',['download'=>'pdf'])}}" target="_blank"><i class="hthtg lni lni-printer"></i></a> --}}
            </div>
          </div>
          <!-- end col -->
          <div class="col-md-4">
            <div class="right">
              <div class="table-search d-flex" style="margin-top: -35px;float: right;">
                <form action="/admin/machines/search_filter_list" method="POST">
                  @csrf
                  ...
                  <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="min-width"><h5 class="text-bold text-dark"><a href="/admin/machines/edit/{{$machine->id}}">{{ $machine->name }}</a></h5></td>
                            <td class="min-width">
                            ...
                            <td class="text-right">
                                <div class="btn-group">
                                    <div class="action">
                                      <a href="/admin/machines/show/{{$machine->id}}">
                                    ...
                                    @endcan
                                    @can('machine-sa-delete')
                                    <form method="POST" action="/admin/machines/delete/{{$machine->id}}">
                                        @csrf
                                        <div class="action">
