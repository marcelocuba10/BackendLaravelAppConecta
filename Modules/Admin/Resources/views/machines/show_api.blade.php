          ...
          <div class="breadcrumb-wrapper mb-30">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="/admin/machines/list_api">Máquinas</a></li>
              ...
              <div class="row">
                <div class="col-4">
                  <div class="input-style-1">
                    <label>Nombre</label>
                    <input type="text" value="{{ $machine->worker_name }}" readonly>
                  </div>
                </div>
                <!-- end col -->
                <div class="col-4">
                ...
                <div class="col-12">
                  <div class="button-groupd-flexjustify-content-centerflex-wrap">
                    <a class="main-btn danger-btn-outline m-2" href="/admin/machines/list_api">Atrás</a>
                  </div>
                </div>
              </div>
            </form>
