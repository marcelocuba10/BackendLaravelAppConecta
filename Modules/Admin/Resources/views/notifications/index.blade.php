        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              ...
              @can('notification-sa-create')
                <a href="/admin/notifications/create" class="main-btn info-btn btn-hover btn-sm"><i class="lni lni-plus mr-5"></i> Nuevo</a>
              @endcan  
            </div>
          </div>
          <!-- end col -->
          <div class="col-md-4">
            <div class="right">
              <div class="table-search d-flex" style="margin-top: -35px;float: right;">
                <form action="/admin/notifications/search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="btn-group">
                                    <div class="action">
                                        <a href="/admin/notifications/show/{{$notification->id}}">
                                            <button class="text-active">
                                                <i class="lni lni-eye"></i>
                                            </button>
                                        </a>
                                    </div>
                                    @can('notification-sa-edit')
                                    <div class="action">
                                    ...
                                    @endcan
                                    @can('notification-sa-delete')
                                    <form method="POST" action="/admin/notifications/delete/{{$notification->id}}">
                                        @csrf
                                        <div class="action">
