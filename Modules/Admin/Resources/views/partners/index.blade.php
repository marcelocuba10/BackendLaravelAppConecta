                ...
                <div class="ibox-content">                    
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                @can('user-create')
                                    <a href="{{ route('partners.create') }}" title="Create a partner" class="btn btn-primary btn-xs btn_list_options"><i class="fa fa-plus" aria-hidden="true"></i> New user</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTable"
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeA odd" role="row">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a href="{{ route('partners.show', $partner->id) }}" class="btn btn-success btn-xs btn_list_options">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                                @can('user-edit')
                                                <a href="{{ route('partners.edit', $partner->id) }}" class="btn btn-primary btn-xs btn_list_options">
                            ...
                            {{ $partners->links() }} <!-- paginacion default -->
