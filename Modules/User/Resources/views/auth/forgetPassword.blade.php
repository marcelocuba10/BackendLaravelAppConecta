    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="ibox-content recovery-ibox">
                <div class="grfsd">
                    <a href="/user/recovery-options"><i class="fa fa-arrow-left" aria-hidden="true"></i> <span class="dfdfdf">Back</span></a>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @endif
                        <form class="m-t" role="form" action="/user/forget-password" method="POST">
                            @csrf
