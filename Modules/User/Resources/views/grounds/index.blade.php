                ...
                <div class="ibox-content">                    
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <a href="/user/grounds/create/" title="Nueva Cancha" class="btn btn-primary btn-xs btn_list_options"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Cancha</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    <tr class="gradeA odd" role="row">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('grounds.show', $ground->id) }}" class="btn btn-success btn-xs btn_list_options">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                                <a href="{{ route('grounds.edit', $ground->id) }}" class="btn btn-primary btn-xs btn_list_options">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </a>
                                                <form method="POST" action="{{ route('grounds.destroy',$ground->id) }}">
                                                    @csrf
                            ...
                            {{ $grounds->links() }} <!-- paginacion default -->
