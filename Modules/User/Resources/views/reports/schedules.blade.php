        ...
        <div class="row align-items-center">
          <div class="col-md-8">
            <div class="title d-flex align-items-center flex-wrap mb-30">
              <h2 class="mr-40">Relatorio de Horarios</h2>
            </div>
          </div>
          <!-- end col -->
          <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="input-style-1">
                          ...
                          <form action="/user/reports/schedules/search">
                      ...
                      <div class="col-md-3">
                        <div class="input-style-1">
                          ...
                          <a href="{{route('reports.schedules',['download'=>'pdf'])}}" class="btn btn-lg success-btn rounded-md btn-hover" target="_blank"><i class="lni lni-printer"></i></a>
                        </div>
                      </div>
                    </div>
                  </form>
                ...
                <table class="invoice-table table">
                  <thead>
                    <tr>
                      ...
                      <th class="md">
                        <h6 class="text-sm text-medium">Horario Entrada</h6>
                      </th>
                      <th class="md">
                        <h6 class="text-sm text-medium">Horario Salida</h6>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
